...
const AddHotelFacilities = () => {
  ...
  const deleteHotelFacility = (facilityId) => {
    axios.delete(`http://localhost:8080/api/facility/hotel/${hotelId}/remove?facilityId=${facilityId}`)
      .then((response) => {
        if (response.data.responseCode === "SUCCESS") {
          toast.error("Failed to remove facility. Please try again.");
        
          setHoteFacilities(prevFacilities => prevFacilities.filter(f => f.id !== facilityId));
        } else {
      ...
      .catch((error) => {
        ...
        toast.error("An error occurred while removing facility.");
      });
                      ...
                      <tr>
                        ...
                        <td>
                          <button
                            ...
                            onClick={() => deleteHotelFacility(f.id)}
                          >
                            Delete
                          </button>
                        </td>
