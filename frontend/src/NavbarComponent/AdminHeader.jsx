    ...
    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 me-5">
      <li className="nav-item">
        <Link
          ...
          aria-current="page"
        >
          <b className="text-white">Add Location</b>
        </Link>
      </li>
      ...
      <li className="nav-item">
        <Link
          ...
          aria-current="page"
        >
          <b className="text-white">Add Facility</b>
        </Link>
      </li>
      ...
      <li className="nav-item">
        <Link
          ...
          aria-current="page"
        >
          <b className="text-white">Register Hotel Manager</b>
        </Link>
      </li>
      ...
      <li className="nav-item">
        <Link
          ...
          aria-current="page"
        >
          <b className="text-white">Add Hotel</b>
        </Link>
      </li>
