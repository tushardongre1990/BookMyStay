...
//			return new ResponseEntity(response, HttpStatus.BAD_REQUEST);
	...
	@ApiOperation(value = "API to fetch all bookings")
	...
	@GetMapping("/fetch")
	@ApiOperation(value = "API to fetch all bookings using user Id")
	public ResponseEntity<?> fetchMyBooking(@RequestParam("userId") int userId) {
		LOG.info("Recieved request for fetch all booking using user Id");
	...
	@GetMapping("/fetch/id")
	@ApiOperation(value = "API to fetch all booking by booking id")
	...
	@ApiOperation(value = "API to fetch all bookings by hotel Id")
	public ResponseEntity<?> fetchMyHotelBooking(@RequestParam("hotelId") int hotelId) {
		LOG.info("Recieved request for fetch all booking by hotel Id");
	...
	@ApiOperation(value = "API to fetch booking status")
